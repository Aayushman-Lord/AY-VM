...
struct StackManager
{
    ...
    bool topToReg(int &counter, const vector<string> &btcode, map<string, Register> &registers)
    {
        if (counter + 2 >= btcode.size())
        {
    ...
    bool dup(int &counter, const vector<string> &btcode)
    {
        if (counter + 1 >= btcode.size())
        {
    ...
    bool handleArithematic(int &counter, const vector<string> &btcode, map<string, Register> &registers, const string &instruction)
    {
